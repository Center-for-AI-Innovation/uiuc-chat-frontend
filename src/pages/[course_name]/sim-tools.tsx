...
import SimToolsPage from '~/components/UIUC-Components/SimPage'
...
const SimTools: NextPage = () => {
  ...
  useEffect(() => {
    const fetchCourseData = async () => {
      ...
      posthog.capture('sim_tools_page_visited', {
  ...
  return (
    <>
      <SimToolsPage course_name={course_name as string} />
    </>
  )
}
