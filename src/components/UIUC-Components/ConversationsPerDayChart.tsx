  ...
  return (
    <div>
      ...
      <div
        ...
        role="region"
        aria-label={t('analysis.conversationsPerDayVisualization') as unknown as string}
      >
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <XAxis
              ...
              label={{
                value: t('analysis.date') as unknown as string,
            ...
            <YAxis
              ...
              label={{
                value: useLogScale
                  ? (t('analysis.numberOfConversationsLog') as unknown as string)
            ...
            <Tooltip
              ...
              formatter={(value: number) => [t('analysis.conversationsCount', { count: value })]}
              labelFormatter={(label) => t('analysis.dateLabel', { date: label })}
            />
            <Bar
              dataKey="count"
