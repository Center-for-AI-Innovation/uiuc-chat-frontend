  ...
  useEffect(() => {
    ...
    if (isErrorLLMProviders) {
      showConfirmationToast({
        title: t('alerts.llm_providers.fetch_error.title') as unknown as string,
        message: t('alerts.llm_providers.fetch_error.message') as unknown as string,
        isError: true,
      })
    }
  }, [isErrorLLMProviders])
      ...
      mutation.mutate(
        ...
        },
        {
          onSuccess: (data, variables, context) => {
            ...
            showConfirmationToast({
              title: t('alerts.llm_providers.update_success.title') as unknown as string,
              message: t('alerts.llm_providers.update_success.message') as unknown as string,
            })
          },
          onError: (error, variables, context) =>
            showConfirmationToast({
              title: t('alerts.llm_providers.update_error.title') as unknown as string,
              message: t('alerts.llm_providers.update_error.message') as unknown as string,
              isError: true,
            }),
        },
      )
              ...
              <Flex className="flex-col md:flex-row">
                ...
                >
                  ...
                  >
                    ...
                    >
                      {t('models.configure_llm_providers_title')}
                    </Title>
                    <Title
                        ...
                        >
                          <>
                            ...
                            <Title
                              ...
                              order={3}
                            >
                              {t('models.open_source_title')}
                            </Title>
                            <Text
                              className={`pl-1 ${montserrat_paragraph.variable} font-montserratParagraph`}
                              size="md"
                            >
                              {t('models.open_source_description')}
                            </Text>
                            <Flex
                              direction={{ base: 'column', '75rem': 'row' }}
                              wrap="wrap"
