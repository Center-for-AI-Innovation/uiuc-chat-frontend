            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="-inset-0.25 relative shrink-0 rounded-3xl p-0.5">
                <Button
                  ...
                  `}
                >
                  <span className="hidden sm:inline">{t('navigation.share_chatbot')}</span>
                  <span className="inline sm:hidden">{t('upload.share')}</span>
        ...
        >
          <div className="card flex h-full flex-col justify-start space-y-6">
            <div className="form-control">
              ...
              <Textarea
                placeholder={t('upload.describe_project_placeholder') as unknown as string}
                radius={'sm'}
            ...
            <div className="space-y-2">
              ...
              <div className="form-control relative">
                ...
                <Textarea
                  ...
                  minRows={2}
                  maxRows={4}
                  placeholder={t('upload.greeting_placeholder') as unknown as string}
