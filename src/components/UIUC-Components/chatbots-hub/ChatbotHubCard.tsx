...
import { Bot, Settings, Share2 } from 'lucide-react'
...
export function ChatbotHubCard({
  course_name,
  title,
  description,
  organization,
  ...
  return (
    <>
      <Card
        className={`h-[380px] w-[320px] shrink-0 overflow-hidden rounded-[14px] bg-white dark:bg-[#13294b] ${
          isOwnerCard
      ...
      >
        <div className="relative flex h-40 items-start justify-end p-3">
          {bannerUrl ? (
