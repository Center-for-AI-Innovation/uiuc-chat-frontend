              ...
              {getCurrentPageName() !== 'chat' &&
                statements.map((statement, index) => (
                  ...
                  >
                    <Button
                      variant="link"
                      className={`text-md h-auto p-2 font-bold leading-relaxed text-[--foreground] hover:text-[--background] hover:underline ${montserrat_paragraph.variable} font-montserParagraph`}
                    >
